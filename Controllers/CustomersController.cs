...
namespace Major_project.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(Major_projectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,First_Name,Last_Name,Gender,DOB")] Customer customer)
        {
